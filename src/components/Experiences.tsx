...
const experiences = [
    {
        ...
        company: "React",
        description: [
            ` Développement et mise en place d’un portfolio personnel en
                  React.js présentant mes projets`,
    ...
    },
    {
        ...
        description: [
            " Utilisation de technologies front-end telles que HTML, CSS, JavaScript/Reactjs",
        ],
        image: meta,
    },
    {
                ...
                <div className="md:ml-4 flex flex-col space-y-4">
                    {
                        experiences.map((experience) => (
                            <div key={experience.id} className="flex flex-col bg-base-200 p-5
