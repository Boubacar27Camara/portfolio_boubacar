...
const projets = [
    ...
    },
    {
        ...
        description: "Creaction d'une application web en Angular",
    ...
    },
    {
        ...
        description: "Creaction d'une application Crud en Spring-Angular",
        technologies: ['Spring boot', 'Angular', 'Tailwind CSS'],
        demoLink: '#',
        repoLink: '#',
        image: img4,
    },
    {
        id: 1,
        title: "Application Crud gestion utilisateur",
    ...
    },
    {
        ...
        description: "Mon projet sur la creation d'une application web en javascript ",
